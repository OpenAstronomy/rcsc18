...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7fe42bbc7160>
```
...
{:.output_data_text}
```
<matplotlib.colorbar.Colorbar at 0x7fe42b7e1668>
```
...
{:.output_data_text}
```
<matplotlib.colorbar.Colorbar at 0x7fe42b7120f0>
```
...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7fe42b676a58>
```
...
{:.output_data_text}
```
<matplotlib.colorbar.Colorbar at 0x7fe42bcb4da0>
```
...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7fe42b4e91d0>
```
...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7fe42b4b9ac8>
```
...
{:.output_data_text}
```
<matplotlib.colorbar.Colorbar at 0x7fe428dcbf60>
```
...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7fe428cbe550>
```
...
{:.output_data_text}
```
<sunpy.visualization.imageanimator.ImageAnimator at 0x7fe428264550>
```
