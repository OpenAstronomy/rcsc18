---
interact_link: notebooks/published/published/01-bash/01-Introduction.ipynb
title: 'Introduction'
permalink: 'chapters/published/published/01-bash/01-Introduction'
previouschapter:
  url: 
  title: 'Bash'
nextchapter:
  url: chapters/published/published/01-bash/02-files-and-directories
  title: 'Files And Directories'
redirect_from:
  - 'chapters/published/published/01-bash/01-introduction'
---
