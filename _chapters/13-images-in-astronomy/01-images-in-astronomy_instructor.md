...
{:.output_data_text}
```
<SkyCoord (Helioprojective: obstime=2018-09-02 14:25:09.098397, rsun=695508.0 km, observer=<HeliographicStonyhurst Coordinate (obstime=2018-09-02 14:25:09.098397): (lon, lat, radius) in (deg, deg, AU)
    (0., 7.21324678, 1.00894009)>): (Tx, Ty) in arcsec
    (100., 700.)>
```
...
{:.output_data_text}
```
<SkyCoord (HeliographicStonyhurst: obstime=2018-09-02 14:25:09.098397): (lon, lat, radius) in (deg, deg, km)
    (10.36813314, 54.35280313, 695508.00000614)>
```
...
{:.output_data_text}
```
[<astropy.io.fits.hdu.image.PrimaryHDU object at 0x7f4560b9e5f8>]
```
...
{:.output_data_text}
```
<matplotlib.image.AxesImage at 0x7f455e9cbcf8>
```
...
{:.output_data_text}
```
[<matplotlib.lines.Line2D at 0x7f455e996a20>]
```
...
{:.output_data_text}
```
[<matplotlib.lines.Line2D at 0x7f4560c236d8>]
```
...
{:.output_data_text}
```
[<matplotlib.lines.Line2D at 0x7f455e9cbb38>]
```
